...
**Counts (reconciled in PHASE-1C3-SLICE-F, 2026-04-30; updated PHASE-2-PREP-FOLLOWUPS, 2026-05-01; updated PHASE-2A remediation, 2026-06-03 — F-OPS-6 opened; updated PHASE-2A determinism gate, 2026-08-24 — F-POSE-1/2/3 and F-INFRA-1 opened):** **32 total entries** — 12 risks (`R-01`–`R-12`) and **20 findings** (`F-*`). Plus **10 verification tasks** (`V-1c.3-01`–`V-1c.3-10`) tracked in [`docs/process/phase-1c3-prep-backlog.md`](../process/phase-1c3-prep-backlog.md). Status distribution: risks — 8 open, 3 mitigated (R-01, R-05, R-07), 1 closed (R-12); findings — 15 open, 2 deferred (F-SLICE-B-1, F-CALIB-1), 3 resolved (F-SLICE-E-4, E-5, E-6). New finding-area prefixes `F-POSE-` (pose-engine/determinism) and `F-INFRA-` (service runtime/deployment) introduced alongside `F-CALIB-`; all match the `F-<AREA>-<N>` convention in `_schema.md`.
...
| [F-POSE-1](F-POSE-1-process-wide-video-mode-landmarker-leaks-tracking-state-across-requests.md) | Process-wide VIDEO-mode landmarker leaks tracking state across requests and athletes | open | Sev-1 | PHASE-2A | ADR-0005, ADR-0009, ADR-0014 | F-SLICE-E-2, F-POSE-2, F-CALIB-1, F-SLICE-B-1 |
| [F-POSE-2](F-POSE-2-auto-zoom-probe-implies-1000-fps-timestamps-to-video-mode-tracker.md) | Auto-zoom probe implies 1000 fps timestamps to the VIDEO-mode tracker | open | Sev-2 | PHASE-2A | ADR-0009 | F-POSE-1, F-SLICE-E-2 |
| [F-POSE-3](F-POSE-3-world-keypoints-silently-zeroed-when-auto-zoom-fires.md) | `world_keypoints` silently zeroed when auto-zoom fires (reverse-map omission) | open | Sev-2 | PHASE-2A | ADR-0005 | F-POSE-1, F-SLICE-E-2 |
| [F-INFRA-1](F-INFRA-1-4k-frame-buffers-held-twice-per-request-dominate-service-memory.md) | 4K frame buffers held twice per request dominate service memory; OOM risk scales with Cloud Run concurrency | open | Sev-1 | PHASE-2A | ADR-0009 | F-POSE-1 |
