...
**Counts (reconciled in PHASE-1C3-SLICE-F, 2026-04-30; updated PHASE-2-PREP-FOLLOWUPS, 2026-05-01; updated PHASE-2A remediation, 2026-06-03 — F-OPS-6 opened; updated PHASE-2A determinism gate, 2026-08-24 — F-POSE-1/2/3 opened):** **31 total entries** — 12 risks (`R-01`–`R-12`) and **19 findings** (`F-*`). Plus **10 verification tasks** (`V-1c.3-01`–`V-1c.3-10`) tracked in [`docs/process/phase-1c3-prep-backlog.md`](../process/phase-1c3-prep-backlog.md). Status distribution: risks — 8 open, 3 mitigated (R-01, R-05, R-07), 1 closed (R-12); findings — 14 open, 2 deferred (F-SLICE-B-1, F-CALIB-1), 3 resolved (F-SLICE-E-4, E-5, E-6). New finding-area prefix `F-POSE-` introduced for pose-engine/determinism findings, alongside `F-CALIB-`; both match the `F-<AREA>-<N>` convention in `_schema.md`.
