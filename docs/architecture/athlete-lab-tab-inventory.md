...
<!-- Generated by scripts/generate-tab-inventory.ts.
     Source: src/features/athlete-lab/components/NodeEditor.tsx (TABS array, lines 60–77).
...
**Auto-derived snapshot** — 13 TABS entries (13 visible, 0 hidden).
...
| 8 | Filming Guidance | `camera` | — |
| 9 | Checkpoints | `checkpoints` | ✓ |
| 10 | LLM Prompt | `prompt` | — |
| 11 | Badges | `badges` | — |
| 12 | Training Status | `training_status` | ✓ |
| 13 | Run Analysis | `test` | — |
