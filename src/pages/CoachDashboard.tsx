    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center gap-6">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        ...
        <div className="bg-surface-container rounded-xl p-12 flex flex-col items-center gap-4 border border-outline-variant/10">
          <span className="material-symbols-outlined text-on-surface-variant text-5xl">sports</span>
          <h1 className="text-on-surface font-black text-xl uppercase tracking-[0.2em]">Coach Dashboard</h1>
