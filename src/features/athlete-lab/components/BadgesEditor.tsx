    ...
    <div className="relative">
      ...
      {show && (
        <>
          ...
          <div className="absolute z-50 top-full mt-1 right-0 p-3 rounded-xl border border-outline-variant/20 bg-[#1A2029] shadow-xl grid grid-cols-4 gap-1.5 w-[180px] max-h-[280px] overflow-y-auto">
